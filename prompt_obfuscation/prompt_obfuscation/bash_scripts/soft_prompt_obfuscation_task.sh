...
# data point for the "Task" scenario in Table 4 of the paper.
...
OUTPUT_DIR="results/soft_${DATASET_NAME}_task_${RUN_ID}"

echo -e "${BLUE}--- Running Soft Prompt Obfuscation (Task Scenario) on dataset: $DATASET_NAME ---${NC}"
echo -e "${BLUE}--- Output directory: $OUTPUT_DIR ---${NC}"

# --- Step 1: Run Obfuscation (with blank style prompt) ---
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ Successfully completed all steps for dataset '$DATASET_NAME' (Task Scenario)${NC}"
