...
# This script runs the soft prompt obfuscation pipeline to reproduce a single 
# data point for the "Full" scenario in Table 4 of the paper.
...
OUTPUT_DIR="results/soft_${STYLE}_${DATASET_NAME}_full_${RUN_ID}"

echo -e "${BLUE}--- Running Soft Prompt Obfuscation (Full Scenario) for style: $STYLE on dataset: $DATASET_NAME ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ Successfully completed all steps for style: '$STYLE' on '$DATASET_NAME' (Full Scenario)${NC}"
