...
# This script runs a FAST, MINIMAL configuration of the Experiment E8 pipeline.
...
echo -e "${BLUE}--- Running FAST CHECK for E8: Soft Fluency Deobfuscation ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ FAST CHECK for E8 completed successfully!${NC}"
