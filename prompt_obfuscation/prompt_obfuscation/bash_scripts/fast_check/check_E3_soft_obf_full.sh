...
OUTPUT_DIR="results/fast_check/E3_soft_${STYLE}_${DATASET_NAME}_full_${RUN_ID}"

echo -e "${BLUE}--- Running FAST CHECK for E3: Soft Prompt Obfuscation (Full Scenario) ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ FAST CHECK for E3 and style '$STYLE' on dataset '$DATASET_NAME' completed successfully! (Full Scenario)${NC}"
