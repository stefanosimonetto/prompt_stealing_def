...
OUTPUT_DIR="results/fast_check/E3_soft_${DATASET_NAME}_task_${RUN_ID}"

echo -e "${BLUE}--- Running FAST CHECK for E3: Soft Prompt Obfuscation (Task Scenario) ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ FAST CHECK for E3 on dataset '$DATASET_NAME' completed successfully! (Task Scenario)${NC}"
