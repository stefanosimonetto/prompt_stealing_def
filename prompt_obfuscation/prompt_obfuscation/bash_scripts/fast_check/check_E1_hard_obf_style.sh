...
# This script runs a FAST, MINIMAL configuration of the Experiment E1 (Style) pipeline.
...
OUTPUT_DIR="results/fast_check/E1_hard_${STYLE}_style_${RUN_ID}"

echo -e "${BLUE}--- Running FAST CHECK for E1: Hard Prompt Obfuscation (Style Scenario) for style: $STYLE ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ FAST CHECK for E1 and style '$STYLE' completed successfully! (Style Scenario)${NC}"
