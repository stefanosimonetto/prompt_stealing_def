...
OUTPUT_DIR="results/fast_check/E5_finetuning_${STYLE}_${DATASET_NAME}_full_${RUN_ID}"

echo -e "${BLUE}--- Running FAST CHECK for E5: LoRa Finetuning (Full Scenario) ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ FAST CHECK for E5 and style '$STYLE' on dataset '$DATASET_NAME' completed successfully! (Full Scenario)${NC}"
