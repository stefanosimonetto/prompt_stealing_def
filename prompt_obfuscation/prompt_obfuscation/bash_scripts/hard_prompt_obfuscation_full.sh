...
# for the "Full" scenario in Table 1 of the paper.
...
STYLE=$2
OUTPUT_DIR="results/hard_${STYLE}_full_${RUN_ID}"

echo -e "${BLUE}--- Running Hard Prompt Obfuscation (Full Scenario) for style: $STYLE ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ Successfully completed all steps for style: '$STYLE' (Full Scenario)${NC}"
