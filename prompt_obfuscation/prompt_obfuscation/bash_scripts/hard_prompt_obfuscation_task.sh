...
# This script runs the full pipeline to reproduce the data point
# for the "Task" scenario in Table 1 of the paper.
...
OUTPUT_DIR="results/hard_task_only_${RUN_ID}"

echo -e "${BLUE}--- Running Hard Prompt Obfuscation (Task Scenario) ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ Successfully completed all steps for the Task Scenario.${NC}"
