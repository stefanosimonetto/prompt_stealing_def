...
# This script runs the HARD fluency deobfuscation attack to reproduce the
# results for Table 10 of the paper. This attack optimizes the discrete
# tokens using GCG. It should be run AFTER a soft prompt obfuscation experiment.
...
echo -e "${BLUE}--- Running HARD Fluency Deobfuscation Attack (for Table 10) ---${NC}"
...
echo -e "\n${BLUE}---${NC}"
echo -e "${GREEN}✅ Successfully completed hard fluency deobfuscation attack.${NC}"
echo "You can now find the result files in the '$RESULTS_DIR' directory to verify the results in Table 10."
